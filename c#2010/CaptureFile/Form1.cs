...
"mm/dd/yyyy.mm:ss","dd/mm/yyyy.mm:ss","mm.dd.yyyy.mm:ss","dd.mm.yyyy.mm:ss"});
           ...
           if (this.audioInputComboBox.Items.Count > 0)
           {
            ...
            for (int i = 0; i < (int)axVideoCap1.GetAudioCompressorCount(); i++)
            {
                this.audioCompressorComboBox.Items.Add(axVideoCap1.GetAudioCompressorName((short)i));
            }
            if (this.audioCompressorComboBox.Items.Count > 0)
            {
                this.audioCompressorComboBox.SelectedIndex = 0;
            }

            for (int i = 0; i < (int)axVideoCap1.GetVideoCompressorCount(); i++)
            {
                this.videoCompressorComboBox.Items.Add(axVideoCap1.GetVideoCompressorName((short)i));
            }
            if (this.videoCompressorComboBox.Items.Count > 0)
            {
                this.videoCompressorComboBox.SelectedIndex = 0;
            }
        }
